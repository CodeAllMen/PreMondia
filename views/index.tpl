        ...
        <div class="modal-content">
            ...
            <form id="formOne" action="" >
                <div class="modal-body noPadding">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-2">
                            <div class="zhezhao">
                                <input type="text" class="form-control radius" id="userNameOne"  placeholder="Mobile number or username">
                            </div>
                            <div class="zhezhao" >
                            ...
                            <div class="zhezhao">
                                ...
                                <div style="float:left">
                                    <span class="radioLable">Remember</span>
                                </div>
                            </div>
                           <h6 class="coinsError" id="loginError" style="margin-top:30px"></h6>
                        </div>
                      </div>
                ...
                <div class="modal-footer">
                    ...
                    <!--<a id="modal-801870" href="#" role="button" data-toggle="modal" id="checkFirstLogin" class="btn showAll">LOGIN</a><button type="button" class="btn gray" >XX</button>-->
                    <a  href="#" role="button" data-toggle="modal" id="checkFirstLogin" class="btn showAll">Login</a><button type="button" class="btn gray" >Subscribe</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <div class="modal-body noPadding">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-2">
                        ...
                        <div class="zhezhao">
                            <h6>We will give you 6 coins for each successful payment every day until you cancel your subscription.</h6>
                        </div>
                        <h6 class="coinsError" id="setError"></h6>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
